...
const taskInstructions = {
  ...
  grade_short_answer: 'Grade meaning, not exact wording. Return a 0-1 score, a boolean result, specific feedback, and an ideal answer grounded in the provided rubric and evidence. The score is the FRACTION of the rubric the answer earned, so an answer giving one of three required points scores about 0.33, not 1.0. `correct` must agree with it: true when score >= 0.7, false otherwise. A false verdict beside a high score is a contradiction the student sees. The feedback must not contradict your own `ideal_answer`: if a statement the student made also appears in `ideal_answer`, it is CORRECT and must be credited, never called wrong. Name what the answer got right first, then name only the rubric points it actually left out. Marking a right statement wrong because the answer was incomplete is the single worst thing this grader can do -- the student stops trusting every grade after it.',
